...
public class Example {
  ...
  public static void OidInfoExample(){
	  ...
	  MibModel mibModel=MibBrowserUtils.getOidInfo("E:/project/nms46/WebContent/WEB-INF/config/mib/CISCO-PRODUCTS-MIB.mib", "1.3.6.1.4.1.9.1.693");
	  printlnMibModel(mibModel);
	  MibModel mibModel1=MibBrowserUtils.getOidInfo(MibBrowserUtils.getAllOid("mib地址"), "1.3.6.1.4.1.9.1.693");
