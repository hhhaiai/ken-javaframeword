 ...
 * </pre>
 */
final public class InternetIPSeeker {
	/**
	...
	// 单例
	private static InternetIPSeeker instance = new InternetIPSeeker();
	// 起始地区的开始和结束的绝对偏移
	...
	private InternetIPSeeker() {
		...
		b3 = new byte[3];
		try {
			ipFile = new RandomAccessFile(this.getClass().getResource("").getPath()+IP_FILE, "r");
	 ...
	 * @return 单一实例
	 */
	public static InternetIPSeeker getInstance() {
		return instance;
	}
