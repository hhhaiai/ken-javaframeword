/*
 * ooweb Copyright(c)2005, ooweb developers (see the accompanying "AUTHORS"
 * file) This software is licensed under the APACHE LICENSE, Version 2.0 For
 * more information on distributing and using this program, please see the
 * accompanying "COPYING" file.
 */
/*
 * Copyright 2004,2005 The Apache Software Foundation. Licensed under the Apache
...
/**
 * IDGenerator Code borrowed from AuthenticatorBase.java for generating a secure
 * id's.
 * 
