...
// 查询
function query(ipAddress){
    var mainForm = document.mainForm;
    mainForm.action = "${rootPath}detail/ipTrafficDetail_list?ipAddress=" + ipAddress;
    mainForm.submit();
}

// 分页
function getPage(pageNo, totalPage, ipAddress){
   document.mainForm.action = 
   '${rootPath}detail/ipTrafficDetail_list?curPage=' + pageNo + '&totalPage=' + totalPage + '&ipAddress=' + ipAddress;
    ...
    <div class="page_wrapper limit_770">
        ...
        <div class="report">
            ...
            <div class="std_pagination">
                ...
                onclick="getPage(1, ${dto.totalPage}, '${dto.ipAddress}')" />
                <img class="btn" title="上一页" src="${imagePath}icons/go_pre.gif"
                onclick="getPage(${dto.curPage - 1}, ${dto.totalPage}, '${dto.ipAddress}')" />
                ...
                onclick="getPage(${dto.totalPage}, ${dto.totalPage}, '${dto.ipAddress}')" />
