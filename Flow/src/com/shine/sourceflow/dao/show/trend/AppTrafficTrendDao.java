...
import com.shine.sourceflow.dao.show.trend.strategy.AppTrafficTrendStdQueryStrategy;

public class AppTrafficTrendDao extends TrendGenericDao {
	public AppTrafficTrendDao() {
		this.queryStrategy = new AppTrafficTrendStdQueryStrategy();
	}
