...
import com.shine.sourceflow.dao.show.trend.strategy.IPGroupTrafficTrendStdQuery;

public class IPGroupTrafficTrendDao extends TrendGenericDao {
	public IPGroupTrafficTrendDao() {
		this.queryStrategy = new IPGroupTrafficTrendStdQuery();
	}
