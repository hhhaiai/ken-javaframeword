...
public class NetFlowUtil 
{
	...
	public static String getRawTableName()
	{
		...
		if( h>=0 && h<=11 )
           return "raw_" + DateUtil.getCurrentDateTimeAsId() + "a";
		else
		   return "raw_" + DateUtil.getCurrentDateTimeAsId() + "b";	
	}
	...
	public static String getNextMonth()
	{
        ...
        Calendar calendar = new GregorianCalendar();
        calendar.setTime(date);
        calendar.add(calendar.MONTH,1);//�������������һ��.���������,������ǰ�ƶ�
    ...
    */
    public static String[] getMonthDays(final String day)
    {
		...
		firstAndLast[1] = day.substring(0,6) + cdar.getActualMaximum(Calendar.DAY_OF_MONTH);
    ...
    public static String[] getWeekDays(final String day)
    {
 		...
 		monthAndSunday[0] = new SimpleDateFormat("yyyyMMdd").format(cal.getTime());
 		
 		cal.add(GregorianCalendar.DAY_OF_MONTH, 6); 
 		monthAndSunday[1] = new SimpleDateFormat("yyyyMMdd").format(cal.getTime());
	 ...
	 */
    public static long[] getBoundaryIPs(final String netAddress,final String netMask)
    {
