...
final public class ArrayUtil {
	 ...
	 * @return
	 */
	public static List<String> addWithReplaceRepeat(List<String> dest,String value){
	 ...
	 * @return
	 */
	public static List<String> addAllWithReplaceRepeat(List<String> dest,List<String> values){
		for(String v:values){
			addWithReplaceRepeat(dest, v);
		}
		return dest;
	}
}
