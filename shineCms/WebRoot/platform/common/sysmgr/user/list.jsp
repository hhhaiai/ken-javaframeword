...
//打开编辑框
function toEdit(id){
	editDialog = $.shine.openDialog({name:"editDialog", title:"编辑用户", url:"${path}sysmgr/user_toEdit.do?e.roleId="+id, width:600, height:200});
}
//删除记录
...
$(document).ready(function() {
	var searchDialog = $("#query-form").omDialog({
        width: 400,
        autoOpen : false,
        modal : true,
        resizable : false,
