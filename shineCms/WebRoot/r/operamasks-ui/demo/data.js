...
omUiDemos.components[0]={
    ...
    comps: [{name: 'omGrid', samples: [
    			...
    			{title: '隔行斑纹', url: 'grid/striped.html',java: 'servlet/OmGridServlet.java'},
    			{title: '列渲染', url: 'grid/column-renderer.html',java: 'servlet/OmGridServlet.java'},
    			{title: '显示勾选框', url: 'grid/checkbox-column.html',java: 'servlet/OmGridServlet.java'},
    			{title: '双击事件', url: 'grid/row-dblclick.html',java: 'servlet/OmGridServlet.java'}
            ]}, {name: 'omTree', samples: [
