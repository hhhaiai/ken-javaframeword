...
/*
 * $Id: om-sortable.js,v 1.5 2012/03/15 06:14:47 linxiaomin Exp $
 * operamasks-ui omSortable 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * operamasks-ui omAjaxSubmit 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * operamasks-ui omBorderLayout 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * $Id: om-calendar.js,v 1.98 2012/03/15 06:14:47 linxiaomin Exp $
 * operamasks-ui omCalendar 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
...
;(function($) {
    ...
    $.omWidget("om.omCalendar", {
        ...
        _init : function() {
            ...
            this._buildParam();
            if (opts.popup) {
                $ele.val() && (opts.date = $.omCalendar.parseDate($ele.val(), opts.dateFormat));
            }
            this._render();
        ...
        _buildParam: function() {
            ...
            !opts.dateFormat &&  (this.defaultFormat = opts.showTime ?  "yy-mm-dd H:i:s" : "yy-mm-dd"); 
            this.EV = [];
            return this;
        },
            ...
            this._buildEvent = function() {
                ...
                cc.EV[0] = con.find('div.om-dbd').bind('click', function(e) {
                    ...
                    if (fOpts.popup && !fOpts.showTime) {
                        ...
                        if(!isNaN(cc.father.dt_date)){  //解决ie7拖动日期仍然回填的问题，如果不是数字则忽略回填
                            var dateStr = $.omCalendar.formatDate(cc.father.dt_date, fOpts.dateFormat || cc.father.defaultFormat);
                ...
                cc.EV[4] = con.find('.om-setime').bind('click', function(e) {
                    ...
                    if ($source.hasClass('ok')) {
                        ...
                        cc.father._render({
                            date: cc._computeDate(cc, _year, _month - 1)
                        });
        ...
        TimeSelector:function(ft, father) {
            ...
            this._timeInit = function() {
                ...
                self.button.bind('click', function(e) {
                    ...
                    if (fOpts.popup) {
                        var dateStr = $.omCalendar.formatDate(d, fOpts.dateFormat || self.father.defaultFormat);
 ...
 * operamasks-ui omFileUpload 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * $Id: om-menu.js,v 1.36 2012/03/15 06:41:31 luoyegang Exp $
 * operamasks-ui om-menu.js 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
    ...
    $.omWidget('om.omMenu', {
        ...
        _init : function(){
            ...
            if($.browser.msie && $.browser.version == '6.0') {
                $ele.css("width", opts.minWidth + 30); //TODO
            }
        },
 ...
 * operamasks-ui omMessageBox 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * operamasks-ui omNumberField 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * operamasks-ui omProgressbar 1.1
 *
 ...
 * $Id: om-slider.js,v 1.33 2012/03/15 06:23:58 wangfan Exp $
 * operamasks-ui omSlider 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
 ...
 * operamasks-ui omSuggestion 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
...
/*
 * $Id: om-tabs.js,v 1.79 2012/03/15 07:16:12 wangfan Exp $
 * operamasks-ui omTabs 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
...
//      return target;
    ...
    $.omWidget('om.omTabs', {
        ...
        _create : function() {
            ...
            $.data($self, 'omtabs').history = [];//页签访问的历史记录
        }, 
 ...
 * $Id: om-tooltip.js,v 1.10 2012/03/15 06:23:58 wangfan Exp $
 * operamasks-ui omTooltip 1.1
 *
 * Copyright 2011, AUTHORS.txt (http://ui.operamasks.org/about)
 * Dual licensed under the MIT or LGPL Version 2 licenses.
 * http://ui.operamasks.org/license
    ...
    $.omWidget('om.omTooltip', {
        ...
        _ajaxLoad:function(url){
            ...
            $.ajax({
                ...
                error: function(XMLHttpRequest, textStatus, errorThrown){
                    self.tip.find('.tip-body').append('加载提示信息出错！');
                }
            });
        },
        /**
