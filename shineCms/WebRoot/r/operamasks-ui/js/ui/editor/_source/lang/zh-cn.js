...
/**
 * @fileOverview Defines the {@link OMEDITOR.lang} object, for the
...
OMEDITOR.lang['zh-cn'] =
{
	...
	image :
	{
		...
		uploadTypeNoAllow : '对不起，只能上传以下格式的文件：'
	},
	...
	about :
	{
		title		: '关于omEditor',
		dlgTitle	: '关于omEditor',
		help	: '访问 $1 寻找更多帮助.', // MISSING
		userGuide : 'omEditor 用户指南', // MISSING
	...
	docprops :
	{
		...
		metaAuthor : '作者',
		metaCopyright : '版权',
		previewHtml : '<p>This is some <strong>sample text</strong>. You are using <a href="javascript:void(0)">OMEditor</a>.</p>' // MISSING
	}
};
