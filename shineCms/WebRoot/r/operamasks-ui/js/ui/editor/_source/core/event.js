...
/**
 * @fileOverview Defines the {@link OMEDITOR.event} class, which serves as the
...
if ( !OMEDITOR.event )
{
	 ...
	 * <br />
	 * Do not confuse this class with {@link OMEDITOR.dom.event} which is
	 * instead used for DOM events. The OMEDITOR.event class implements the
	 * internal event system used by the OMEditor to fire API related events.
	 * @example
	 */
	OMEDITOR.event = function()
	{};

	/**
	 * Implements the {@link OMEDITOR.event} features in an object.
	 * @param {Object} targetObject The object into which implement the features.
	 * @example
	 * var myObject = { message : 'Example' };
	 * <b>OMEDITOR.event.implementOn( myObject }</b>;
	 ...
	 */
	OMEDITOR.event.implementOn = function( targetObject )
	{
		var eventProto = OMEDITOR.event.prototype;
	...
	OMEDITOR.event.prototype = (function()
	{
		...
		return /** @lends OMEDITOR.event.prototype */ {
			/**
			 * Registers a listener to a specific event in the current object.
			 * @param {String} eventName The event name to which listen.
			 * @param {Function} listenerFunction The function listening to the
			 *		event. A single {@link OMEDITOR.eventInfo} object instanced
			 *		is passed to this function containing all the event data.
			 * @param {Object} [scopeObj] The object used to scope the listener
			 *		call (the this object. If omitted, the current object is used.
			 * @param {Object} [listenerData] Data to be sent as the
			 *		{@link OMEDITOR.eventInfo#listenerData} when calling the
			 *		listener.
			 ...
			 *		{@link OMEDITOR.eventInfo#data} when calling the
			 *		listeners.
			 * @param {OMEDITOR.editor} [editor] The editor instance to send as the
			 *		{@link OMEDITOR.eventInfo#editor} when calling the
			 *		listener.
