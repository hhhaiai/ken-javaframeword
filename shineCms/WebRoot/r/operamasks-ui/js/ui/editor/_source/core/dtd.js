...
/**
 * @fileOverview Defines the {@link OMEDITOR.dtd} object, which holds the DTD
 ...
 * alert( !!OMEDITOR.dtd[ 'p' ][ 'div' ] );  "false"
 * @example
 * // Check if "p" can be contained in a "div" element.
 * alert( !!OMEDITOR.dtd[ 'div' ][ 'p' ] );  "true"
 * @example
 * // Check if "p" is a block element.
 * alert( !!OMEDITOR.dtd.$block[ 'p' ] );  "true"
 */
OMEDITOR.dtd = (function()
{
	var X = OMEDITOR.tools.extend,
