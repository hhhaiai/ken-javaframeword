 ...
 */
OMEDITOR.config.basicEntities = true;

/**
 * Whether to use HTML entities in the output.
 * @name OMEDITOR.config.entities
 * @type Boolean
 * @default true
 * @example
 * config.entities = false;
 */
OMEDITOR.config.entities = true;
 ...
 * @name OMEDITOR.config.entities_latin
 * @type Boolean
 * @default true
 * @example
 * config.entities_latin = false;
 */
OMEDITOR.config.entities_latin = true;
 ...
 * @name OMEDITOR.config.entities_greek
 * @type Boolean
 * @default true
 * @example
 * config.entities_greek = false;
 */
OMEDITOR.config.entities_greek = true;
 ...
 * @name OMEDITOR.config.entities_processNumerical
 * @type Boolean|String
 * @default false
 * @example
 ...
 * @name OMEDITOR.config.entities_additional
 * @default '#39'  // The single quote (') character.
 * @type String
 * @example
 */
OMEDITOR.config.entities_additional = '#39';
