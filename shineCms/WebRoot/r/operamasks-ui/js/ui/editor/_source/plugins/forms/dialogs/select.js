...
*/
OMEDITOR.dialog.add( 'select', function( editor )
{
	...
	return {
		...
		minWidth : OMEDITOR.env.ie ? 460 : 395,
		minHeight : OMEDITOR.env.ie ? 320 : 300,
		onShow : function()
		{
						...
						[
							{
								...
								validate: function()
								{
									var func = OMEDITOR.dialog.validate.integer( editor.lang.common.validateNumberFailed );
							...
							{
								type : 'html',
								html : '<span>' + OMEDITOR.tools.htmlEncode( editor.lang.select.lines ) + '</span>'
							}
						]
					},
					{
						type : 'html',
						html : '<span>' + OMEDITOR.tools.htmlEncode( editor.lang.select.opAvail ) + '</span>'
					},
					{
						type : 'hbox',
