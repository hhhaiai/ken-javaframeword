...
*/
OMEDITOR.dialog.add( 'textfield', function( editor )
{
	var autoAttributes =
	{
		value : 1,
						...
						[
							{
								...
								accessKey : 'C',
								style : 'width:50px',
								validate : OMEDITOR.dialog.validate.integer( editor.lang.common.validateNumberFailed )
							},
							{
								id : 'maxLength',
								type : 'text',
					...
					},
					{
						...
						commit : function( data )
						{
							...
							if ( OMEDITOR.env.ie )
							{
								...
								{
									var replace = OMEDITOR.dom.element.createFromHtml( '<input type="' + myType + '"></input>', editor.document );
