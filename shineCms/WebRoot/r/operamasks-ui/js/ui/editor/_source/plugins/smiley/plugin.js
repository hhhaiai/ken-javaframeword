...
OMEDITOR.plugins.add( 'smiley',
{
	...
	init : function( editor )
	{
		...
		editor.addCommand( 'smiley', new OMEDITOR.dialogCommand( 'smiley' ) );
		editor.ui.addButton( 'Smiley',
			{
				label : editor.lang.smiley.toolbar,
				command : 'smiley'
			});
		OMEDITOR.dialog.add( 'smiley', this.path + 'dialogs/smiley.js' );
	}
} );
 ...
 * a slash.
 * @name OMEDITOR.config.smiley_path
 * @type String
 * @default {@link OMEDITOR.basePath} + 'plugins/smiley/images/'
 * @example
 ...
 * {@link OMEDITOR.config.smiley_path} setting.
 * @type Array
 * @default (see example)
 * @example
 ...
 * {@link OMEDITOR.config.smiley_images} setting. Each entry in this array list
 * must match its relative pair in the {@link OMEDITOR.config.smiley_images}
 * setting.
 * @type Array
 ...
 *     ];
 */
OMEDITOR.config.smiley_descriptions =
	[
		'smiley', 'sad', 'wink', 'laugh', 'frown', 'cheeky', 'blush', 'surprise',
		'indecision', 'angry', 'angel', 'cool', 'devil', 'crying', 'enlightened', 'no',
		'yes', 'heart', 'broken heart', 'kiss', 'mail'
 ...
 * @name OMEDITOR.config.smiley_columns
 * @type Number
 * @default 8
 * @since 3.3.2
 * @example
