...
(function()
{
	...
	OMEDITOR.lang =
	{
		...
		load : function( languageCode, defaultLanguage, callback )
		{
			...
			if ( !languageCode || !OMEDITOR.lang.languages[ languageCode ] )
		 ...
		 * @example
		 * alert( OMEDITOR.lang.detect( 'en' ) );  // e.g., in a German browser: "de"
		 */
