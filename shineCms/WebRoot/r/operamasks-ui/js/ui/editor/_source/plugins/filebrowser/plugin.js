...
( function()
{
	...
	function browseServer( evt )
	{
		...
		params.OMEditor = editor.name;
		params.OMEditorFuncNum = editor._.filebrowserFn;
		if ( !params.langCode )
	 ...
	 * @param {OMEDITOR.dialog.definitionObject}
	 *            definition Dialog definition.
	 * @param {Array}
	 *            elements Array of {@link OMEDITOR.dialog.definition.content}
	 *            objects.
	 */
	...
	OMEDITOR.plugins.add( 'filebrowser',
	{
		init : function( editor, pluginPath )
		{
			editor._.filebrowserFn = OMEDITOR.tools.addFunction( setUrl, editor );
			editor.on( 'destroy', function () { OMEDITOR.tools.removeFunction( this._.filebrowserFn ); } );
		}
	} );
 ...
 * @see The <a href="http://docs.cksource.com/OMEditor_3.x/Developers_Guide/File_Browser_(Uploader)">File Browser/Uploader</a> documentation.
 * @name OMEDITOR.config.filebrowserBrowseUrl
 * @since 3.0
 * @type String
 ...
 * @name OMEDITOR.config.filebrowserUploadUrl
 * @see The <a href="http://docs.cksource.com/OMEditor_3.x/Developers_Guide/File_Browser_(Uploader)">File Browser/Uploader</a> documentation.
 * @since 3.0
 * @type String
 * @default '' (empty string = disabled)
 ...
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserBrowseUrl}.
 * @name OMEDITOR.config.filebrowserImageBrowseUrl
 * @since 3.0
 * @type String
 * @default '' (empty string = disabled)
 * @example
 ...
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserBrowseUrl}.
 * @name OMEDITOR.config.filebrowserFlashBrowseUrl
 * @since 3.0
 * @type String
 * @default '' (empty string = disabled)
 * @example
 ...
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserUploadUrl}.
 * @name OMEDITOR.config.filebrowserImageUploadUrl
 * @since 3.0
 * @type String
 * @default '' (empty string = disabled)
 * @example
 ...
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserUploadUrl}.
 * @name OMEDITOR.config.filebrowserFlashUploadUrl
 * @since 3.0
 * @type String
 * @default '' (empty string = disabled)
 * @example
 ...
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserBrowseUrl}.
 * @name OMEDITOR.config.filebrowserImageBrowseLinkUrl
 * @since 3.2
 * @type String
 * @default '' (empty string = disabled)
 * @example
 ...
 * @name OMEDITOR.config.filebrowserWindowFeatures
 * @since 3.4.1
 * @type String
 ...
 * @name OMEDITOR.config.filebrowserWindowWidth
 * @type Number|String
 * @default '80%'
 * @example
 ...
 * @name OMEDITOR.config.filebrowserWindowHeight
 * @type Number|String
 * @default '70%'
 * @example
