...
(function()
{
	...
	OMEDITOR.dialog.add( 'iframe', function( editor )
	{
		...
		return {
			...
			onOk : function()
			{
				var iframeNode;
				if ( !this.fakeImage )
					iframeNode = new OMEDITOR.dom.element( 'iframe' );
				else
							...
							[
								{
									...
									required : true,
									validate : OMEDITOR.dialog.validate.notEmpty( iframeLang.noUrl ),
									setup : loadValue,
									commit : commitValue
								}
							]
							...
							[
								{
									...
									validate : OMEDITOR.dialog.validate.htmlLength( commonLang.invalidHtmlLength.replace( '%1', commonLang.width ) ),
									setup : loadValue,
									commit : commitValue
								},
								{
									...
									validate : OMEDITOR.dialog.validate.htmlLength( commonLang.invalidHtmlLength.replace( '%1', commonLang.height ) ),
									setup : loadValue,
									commit : commitValue
								},
								{
