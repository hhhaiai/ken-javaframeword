...
/**
 * @fileOverview Defines the {@link OMEDITOR.lang} object, for the English
...
OMEDITOR.lang['en'] =
{
	...
	image :
	{
		...
		uploadTypeNoAllow : 'Sorry, only the following types of files are allowed：'
	},
	...
	about :
	{
		title		: 'About omEditor',
		dlgTitle	: 'About omEditor',
		help	: 'Check $1 for help.',
		userGuide : 'omEditor User\'s Guide',
	...
	docprops :
	{
		...
		previewHtml : '<p>This is some <strong>sample text</strong>. You are using <a href="javascript:void(0)">OMEditor</a>.</p>'
	}
};
