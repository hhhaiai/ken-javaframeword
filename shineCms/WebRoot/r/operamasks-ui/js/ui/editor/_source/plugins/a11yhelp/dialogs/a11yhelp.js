...
OMEDITOR.dialog.add( 'a11yHelp', function( editor )
{
	...
	keyMap[ OMEDITOR.ALT ] = 'ALT';
	keyMap[ OMEDITOR.SHIFT ] = 'SHIFT';
	keyMap[ OMEDITOR.CTRL ] = 'CTRL';

	// Sort in desc.
	var modifiers = [ OMEDITOR.ALT, OMEDITOR.SHIFT, OMEDITOR.CTRL ];
