...
(function()
{
	...
	OMEDITOR.plugins.add( 'flash',
	{
		init : function( editor )
		{
			editor.addCommand( 'flash', new OMEDITOR.dialogCommand( 'flash' ) );
			editor.ui.addButton( 'Flash',
				{
					label : editor.lang.common.flash,
					command : 'flash'
				});
			OMEDITOR.dialog.add( 'flash', this.path + 'dialogs/flash.js' );
				...
				editor.contextMenu.addListener( function( element, selection )
					{
						if ( element && element.is( 'img' ) && !element.isReadOnly()
							...
							return { flash : OMEDITOR.TRISTATE_OFF };
					});
			}
		},
