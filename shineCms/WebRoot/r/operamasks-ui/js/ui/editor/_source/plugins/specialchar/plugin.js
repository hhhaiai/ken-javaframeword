...
OMEDITOR.plugins.add( 'specialchar',
{
	...
	init : function( editor )
	{
		...
		// Register the dialog.
		OMEDITOR.dialog.add( pluginName, this.path + 'dialogs/specialchar.js' );
		...
		editor.addCommand( pluginName,
			{
				exec : function()
				{
					...
					OMEDITOR.scriptLoader.load(
							...
							function()
							{
								OMEDITOR.tools.extend( editor.lang.specialChar, plugin.langEntries[ langCode ] );
