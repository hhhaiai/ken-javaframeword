...
OMEDITOR.plugins.add( 'sourcearea',
{
	requires : [ 'editingblock' ],

	init : function( editor )
	{
		var sourcearea = OMEDITOR.plugins.sourcearea,
			win = OMEDITOR.document.getWindow();
				...
				editor.addMode( 'source',
					{
						load : function( holderElement, data )
						{
							...
							editor.textarea = textarea = new OMEDITOR.dom.element( 'textarea' );
							...
							var styles =
							{
								...
								width	: OMEDITOR.env.ie7Compat ?  '99%' : '100%',
								height	: '100%',
								resize	: 'none',
								outline	: 'none',
								'text-align' : 'left'
							...
							( OMEDITOR.env.gecko || OMEDITOR.env.webkit ) ? 100 : 0 );
						},
	...
	commands :
	{
		source :
		{
			...
			exec : function( editor )
			{
				...
				editor.getCommand( 'source' ).setState( OMEDITOR.TRISTATE_DISABLED );
