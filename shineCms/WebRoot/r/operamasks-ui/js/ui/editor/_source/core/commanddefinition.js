...
/**
 * @fileOverview Defines the "virtual" {@link OMEDITOR.commandDefinition} class,
 ...
 * of the API.
 * @name OMEDITOR.commandDefinition
 * @class Virtual class that illustrates the features of command objects to be
 *		passed to the {@link OMEDITOR.editor.prototype.addCommand} function.
 * @example
 */

 /**
 * The function to be fired when the commend is executed.
 * @name OMEDITOR.commandDefinition.prototype.exec
 * @function
 * @param {OMEDITOR.editor} editor The editor within which run the command.
 ...
 * @name  OMEDITOR.commandDefinition.prototype.canUndo
 * @type {Boolean}
 * @default true
 * @field
 * @example
 ...
 * {@link OMEDITOR.editor#event:afterCommandExec} event will be fired by the
 * command itself manually, and that the return value of this command is not to
 * be returned by the {@link OMEDITOR.command#exec} function.
 * @name  OMEDITOR.commandDefinition.prototype.async
 * @default false
 * @type {Boolean}
 * @example
 ...
 *         OMEDITOR.ajax.loadXml( 'data.xml', function()
 *             {
 ...
 * @name  OMEDITOR.commandDefinition.prototype.editorFocus
 * @type {Boolean}
 * @default true
 * @see OMEDITOR.command#editorFocus
 * @example
...
/**
 * Whether the command state should be set to {@link OMEDITOR.TRISTATE_DISABLED} on startup.
 * @name  OMEDITOR.commandDefinition.prototype.startDisabled
 * @type {Boolean}
 * @default false
 * @example
 ...
 * @name  OMEDITOR.commandDefinition.prototype.modes
 * @type Object
 * @default { wysiwyg : 1 }
 * @see OMEDITOR.command#modes
 * @example
