...
/**
 * @fileOverview Defines the {@link OMEDITOR.config} object, which holds the
 * default configuration settings.
 */

/**
 * Used in conjuction with {@link OMEDITOR.config.enterMode} and
 * {@link OMEDITOR.config.shiftEnterMode} to make the editor produce &lt;p&gt;
...
/**
 * Used in conjuction with {@link OMEDITOR.config.enterMode} and
 * {@link OMEDITOR.config.shiftEnterMode} to make the editor produce &lt;br&gt;
 * tags when using the ENTER key.
 * @constant
 */
OMEDITOR.ENTER_BR	= 2;
...
/**
 * Used in conjuction with {@link OMEDITOR.config.enterMode} and
 * {@link OMEDITOR.config.shiftEnterMode} to make the editor produce &lt;div&gt;
 * tags when using the ENTER key.
 * @constant
 */
...
OMEDITOR.config =
{
	 ...
	 * file present in the root of the OMEditor installation directory.<br /><br />
	 *
	 * OMEditor will recursively load custom configuration files defined inside
	 * other custom configuration files.
	 * @type String
	 * @default '&lt;OMEditor folder&gt;/config.js'
	 * @example
	 * // Load a specific configuration file.
	 * OMEDITOR.replace( 'myfiled', { customConfig : '/myconfig.js' } );
	 * @example
	 * // Do not load any custom configuration file.
	 * OMEDITOR.replace( 'myfiled', { customConfig : '' } );
	 */
	customConfig : '',
	 ...
	 * used.
	 * @type String|Array
	 * @default '&lt;OMEditor folder&gt;/contents.css'
	 * @example
	 ...
	 * otherwise the {@link OMEDITOR.config.defaultLanguage} language is used.
	 * @default '' (empty)
	 * @type String
	 * @example
	...
	/**
	 * The language to be used if {@link OMEDITOR.config.language} is left empty and it's not
	 ...
	 * behavior:
	 * <ul>
	 *     <li>{@link OMEDITOR.ENTER_P} (1): new &lt;p&gt; paragraphs are created;</li>
	 *     <li>{@link OMEDITOR.ENTER_BR} (2): lines are broken with &lt;br&gt; elements;</li>
	 *     <li>{@link OMEDITOR.ENTER_DIV} (3): new &lt;div&gt; blocks are created.</li>
	 * </ul>
	 * <strong>Note</strong>: It's recommended to use the
	 * {@link OMEDITOR.ENTER_P} value because of its semantic value and
	 * correctness. The editor is optimized for this value.
	 * @type Number
	 * @default {@link OMEDITOR.ENTER_P}
	 * @example
	 * // Not recommended.
	...
	/**
	 * Force the respect of {@link OMEDITOR.config.enterMode} as line break regardless of the context,
	 * E.g. If {@link OMEDITOR.config.enterMode} is set to {@link OMEDITOR.ENTER_P},
	...
	/**
	 * Just like the {@link OMEDITOR.config.enterMode} setting, it defines the behavior for the SHIFT+ENTER key.
	 * The allowed values are the following constants, and their relative
	 * behavior:
	 * <ul>
	 *     <li>{@link OMEDITOR.ENTER_P} (1): new &lt;p&gt; paragraphs are created;</li>
	 ...
	 * </ul>
	 * @type Number
	 * @default {@link OMEDITOR.ENTER_BR}
	 * @example
	 * config.shiftEnterMode = OMEDITOR.ENTER_P;
	 */
	shiftEnterMode : OMEDITOR.ENTER_BR,
	 ...
	 * code of OMEditor (_source/core/config.js).
	 * @type String
	 * @example
	 */
	corePlugins : '',
	 ...
	 * {@link OMEDITOR.config.extraPlugins} and
	 * {@link OMEDITOR.config.removePlugins} for customizations.
	 * @type String
	 * @example
	 */
	plugins :
	 ...
	 * possibly breaking the {@link OMEDITOR.config.plugins} setting.
	 * @type String
	 * @example
	 ...
	 * {@link OMEDITOR.config.plugins} setting, whithout having to touch it and
 ...
 * @name OMEDITOR.config.useComputedState
 * @type Boolean
 * @default true
 * @since 3.4
 * @example
...
// PACKAGER_RENAME( OMEDITOR.config )
