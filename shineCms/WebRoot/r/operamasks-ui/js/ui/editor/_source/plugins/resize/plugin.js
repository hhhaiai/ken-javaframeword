...
OMEDITOR.plugins.add( 'resize',
{
	init : function( editor )
	{
		...
		if ( config.resizable !== false )
		{
			...
			{
				OMEDITOR.document.removeListener( 'mousemove', dragHandler );
				OMEDITOR.document.removeListener( 'mouseup', dragEndHandler );
			...
			var mouseDownFn = OMEDITOR.tools.addFunction( function( $event )
				{
					...
					OMEDITOR.document.on( 'mousemove', dragHandler );
					OMEDITOR.document.on( 'mouseup', dragEndHandler );
			...
			editor.on( 'themeSpace', function( event )
				{
					if ( event.data.space == 'bottom' )
					{
						...
						var resizerHtml =
							...
							' onmousedown="OMEDITOR.tools.callFunction(' + mouseDownFn + ', event)"' +
							'></div>';
 ...
 * @name OMEDITOR.config.resize_minWidth
 * @type Number
 * @default 750
 * @example
 ...
 * @name OMEDITOR.config.resize_minHeight
 * @type Number
 * @default 250
 * @example
 ...
 * @name OMEDITOR.config.resize_maxWidth
 * @type Number
 * @default 3000
 * @example
 ...
 * @name OMEDITOR.config.resize_maxHeight
 * @type Number
 * @default 3000
 * @example
 ...
 * @name OMEDITOR.config.resize_enabled
 * @type Boolean
 * @default true
 * @example
 ...
 * @name OMEDITOR.config.resize_dir
 * @type String
 * @default 'both'
 * @since 3.3
 * @example
