...
OMEDITOR.skins.add( 'eac', (function()
{
...
\
.cke_skin_eac .cke_menuitem a.cke_disabled:hover .cke_icon_wrapper,\
.cke_skin_eac .cke_menuitem a.cke_disabled:focus .cke_icon_wrapper,\
.cke_skin_eac .cke_menuitem a.cke_disabled:active .cke_icon_wrapper\
{\
	background-color: $color !important;\
	border-color: $color !important;\
}\
\
.cke_skin_eac .cke_menuitem a.cke_disabled .cke_icon_wrapper\
{\
	background-color: $color !important;\
	border-color: $color !important;\
}\
...
{\
	background-color: $color !important;\
			...
			OMEDITOR.tools.extend( editor,
			{
				...
				{
					var cssContent,
						uiStyle = getStylesheet( OMEDITOR.document ),
						cssId = '.' + editor.id;
