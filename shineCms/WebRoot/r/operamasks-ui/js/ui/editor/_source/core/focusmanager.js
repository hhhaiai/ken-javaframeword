...
/**
 * @fileOverview Defines the {@link OMEDITOR.focusManager} class, which is used
 ...
 * @example
 * var focusManager = <b>new OMEDITOR.focusManager( editor )</b>;
 * focusManager.focus();
 */
OMEDITOR.focusManager = function( editor )
{
	 ...
	 * @type Boolean
	 * @example
	 * alert( OMEDITOR.instances.editor1.focusManager.hasFocus );  // e.g "true"
	 */
	this.hasFocus = false;
...
OMEDITOR.focusManager.prototype =
{
	/**
	 ...
	 * {@link OMEDITOR.editor#focus} for it instead.
	 * @example
	...
	focus : function()
	{
		...
		if ( !this.hasFocus )
		{
			...
			if ( OMEDITOR.currentInstance )
				OMEDITOR.currentInstance.focusManager.forceBlur();
