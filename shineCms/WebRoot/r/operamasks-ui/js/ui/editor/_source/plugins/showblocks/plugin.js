...
(function()
{
	...
	OMEDITOR.plugins.add( 'showblocks',
	{
		...
		init : function( editor )
		{
			...
			editor.addCss( cssTemplate
				.replace( cssTemplateRegex, 'background-image: url(' + OMEDITOR.getUrl( this.path ) + 'images/block_' )
 ...
 * @name OMEDITOR.config.startupOutlineBlocks
 * @type Boolean
 * @default false
 * @example
