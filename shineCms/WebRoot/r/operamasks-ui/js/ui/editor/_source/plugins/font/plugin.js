	...
	function addCombo( editor, comboName, styleType, lang, entries, defaultLabel, styleDefinition )
	{
		...
		for ( var i = 0 ; i < names.length ; i++ )
		{
			...
			if ( parts )
			{
				...
				styles[ name ] = new OMEDITOR.style( styleDefinition, vars );
 ...
 */
OMEDITOR.config.font_defaultLabel = '';
 ...
 */
OMEDITOR.config.fontSize_sizes =
 ...
 */
OMEDITOR.config.fontSize_defaultLabel = '';
 ...
 *     };
 */
OMEDITOR.config.fontSize_style =
	{
		element		: 'span',
		styles		: { 'font-size' : '#(size)' },
		overrides	: [ { element : 'font', attributes : { 'size' : null } } ]
